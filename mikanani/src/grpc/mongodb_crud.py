...
class MikananiMongoDBCrud(MikananiMongoCrudServicer):
    ...
    def QueryAnime(self, request: QueryAnimeRequest, context: ServicerContext):
    ...
    def UpdateAnime(self, request: UpdateAnimeRequest, context: ServicerContext):
        # TODO: impl
        return super().UpdateAnime(request, context)
    
    def DelAnime(self, request: DelAnimeRequest, context: ServicerContext):
        # TODO: impl
        return super().DelAnime(request, context)