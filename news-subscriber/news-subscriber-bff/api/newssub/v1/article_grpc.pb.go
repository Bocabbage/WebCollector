...
const (
	Article_CreateArticle_FullMethodName = "/api.newssub.v1.Article/CreateArticle"
	Article_UpdateArticle_FullMethodName = "/api.newssub.v1.Article/UpdateArticle"
	Article_DeleteArticle_FullMethodName = "/api.newssub.v1.Article/DeleteArticle"
	Article_GetArticle_FullMethodName    = "/api.newssub.v1.Article/GetArticle"
	Article_ListArticle_FullMethodName   = "/api.newssub.v1.Article/ListArticle"
)
...
var Article_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.newssub.v1.Article",
	...
	Metadata: "api/newssub/v1/article.proto",
}
