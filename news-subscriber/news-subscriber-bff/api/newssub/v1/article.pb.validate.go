...
// Validate checks the field values on ArticalItem with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ArticalItem) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ArticalItem with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ArticalItemMultiError, or
// nil if none found.
func (m *ArticalItem) ValidateAll() error {
	return m.validate(true)
}

func (m *ArticalItem) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ArticalItemMultiError(errors)
	}

	return nil
}

// ArticalItemMultiError is an error wrapping multiple validation errors
// returned by ArticalItem.ValidateAll() if the designated constraints aren't met.
type ArticalItemMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ArticalItemMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m ArticalItemMultiError) AllErrors() []error { return m }

// ArticalItemValidationError is the validation error returned by
// ArticalItem.Validate if the designated constraints aren't met.
type ArticalItemValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e ArticalItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ArticalItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ArticalItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ArticalItemValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ArticalItemValidationError) ErrorName() string { return "ArticalItemValidationError" }

// Error satisfies the builtin error interface
func (e ArticalItemValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = ArticalItemValidationError{}
